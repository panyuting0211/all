    ...
    if (Yii::$app->user->isGuest) {
        ...
        $rightMenus[] =[
          ...
          /*  '<li>'
            ...
            . Html::submitButton(
                '<img src="statics/images/avatar/small.jpg" alt="'.Yii::$app->user->identity->username.'"/>'.Yii::t('common','Logout').'(' . Yii::$app->user->identity->username . ')',
                ['class' => 'btn btn-link']
            )
            . Html::endForm()
            . '</li>';*/
