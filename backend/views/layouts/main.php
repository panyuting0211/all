                            ...
                            <div id="noticeDropdown" class="dropdown-menu dm-notice pull-right">
                                <div role="tabpanel">
                                    ...
                                    <ul class="nav nav-tabs nav-justified" role="tablist">
                                        <li class="active"><a data-target="#notification" data-toggle="tab">消息（2）</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="notification">
                                            ...
                                            <a class="btn-more" href="">查看全部消息 <i
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="reminders">
                                            ...
                                            <a class="btn-more" href="">查看更多提醒 <i
                                                    class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="leftpanel">
       ...
       <!--     <div class="media leftpanel-profile">
                ...
                <div class="media-body">
                    <h4 class="media-heading"><?/*= Yii::$app->user->identity->username */?><a data-toggle="collapse"
